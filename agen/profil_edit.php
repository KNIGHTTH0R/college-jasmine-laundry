    ...
    <body>
        <div class="wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <form method="POST" action="php/profil_edit_proses.php">
                        <div class="container-fluid">
                            <div class="row">
                                <?php
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Nama</label>
                                                            <input type="text" class="form-control border-input" name="nama" placeholder="Nama" value="<?php echo $result['agen_nama'];?>"
                                                            />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control border-input" name="username" placeholder="Username" value="<?php echo $result['login_username'];?>"
                                                            />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="text-center" style="margin-bottom: 34px;">
                                                        <input type="hidden" name="id" value="<?php echo $result['agen_id'];?>" />
