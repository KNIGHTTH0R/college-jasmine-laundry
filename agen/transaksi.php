                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        ?>
                                            <a href="transaksi.php" class="btn btn-info pull-right" style="margin-right: 8px;"  ><i class="fa fa-arrow-left"></i></a>
                                        <?php
                                            }
                                        ?>
                                        <h4 class="title">Data Transaksi</h4>
                                        <p class="category">List dari semua data transaksi <?php echo $_SESSION['agen_nama']?></p>
                                    </div>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    while($result = mysqli_fetch_assoc($query)){
                                                        ...
                                                        echo "<td><a href=transaksi_detail.php?no_nota=$result[nota_id]>Detail</a>";
                                                        echo "&nbsp;&nbsp;&nbsp;";
                                                        echo "<a href='transaksi_edit.php?no_nota=$result[nota_id]'>Edit</a>";
                                                        echo "&nbsp;&nbsp;&nbsp;";
