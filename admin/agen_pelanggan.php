                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <p class="category">List dari semua pelanggan per agen</p>
                                    </div>
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($_GET['nama'])){
                                                        $strQuery = "SELECT pelanggan_id, pelanggan_nama, pelanggan_alamat, pelanggan_notelp FROM pelanggan WHERE pelanggan_deleted = 'false' AND agen_id = $id AND pelanggan_nama LIKE '%$_GET[nama]%' ORDER BY pelanggan_id DESC";
                                                    }else {
                                                        $strQuery = "SELECT pelanggan_id, pelanggan_nama, pelanggan_alamat, pelanggan_notelp FROM pelanggan WHERE pelanggan_deleted = 'false' AND agen_id = $id ORDER BY pelanggan_id DESC";
